...
root = "./src/image-processing/depth-estimation/"
...
"""
CamL_id = root + "data/stereoL.mp4"
CamR_id = root + "data/stereoR.mp4"

CamL= cv2.VideoCapture(CamL_id)
CamR= cv2.VideoCapture(CamR_id)

# Reading the mapping values for stereo image rectification
cv_file = cv2.FileStorage(root + "data/stereo_rectify_maps.xml", cv2.FILE_STORAGE_READ)
...
cv_file = cv2.FileStorage(root + "data/depth_estmation_params_py.xml", cv2.FILE_STORAGE_READ)
...
cv_file = cv2.FileStorage(root + "data/depth_estmation_params_py.xml", cv2.FILE_STORAGE_WRITE)
