...
namespace PreRendering
{
    ...
    {
        public static RenderTexture GetTexture(this DynamicRenderBuffer[] renderBuffers, int pass = int.MaxValue) =>
            renderBuffers[Mathf.Max(0, Mathf.Min(renderBuffers.Length - 1, pass))].targetTexture;
