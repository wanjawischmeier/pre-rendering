...
namespace PreRendering
{
    public class PreRenderer : MonoBehaviour
    {
        ...
        void SetUpTextures()
        {
            Resolution res = Utility.EstimatePanoramaResolution(Screen.width, Screen.height, Camera.main.fieldOfView);
        ...
        void SetShaderConstants()
        {
            ...
            Shader.SetGlobalVector("InputArrayRes", new Vector2(buffer.textures.width, buffer.textures.height));
            Shader.SetGlobalVector("ProjectedRes", new Vector2(projected.width, projected.height));
            Shader.SetGlobalTexture("_InputArray", buffer.textures);
